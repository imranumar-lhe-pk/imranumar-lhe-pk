...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=26&duration=3000&pause=1000&color=667EEA&center=true&vCenter=true&width=700&lines=Frontend+Developer;React+%26+Next.js+Specialist;Production+UI+Engineer;B2B+Platform+Experience;Clean+%26+Scalable+UI" />
...
Frontend Developer with **1+ year of professional experience** building scalable, production-ready interfaces using **React.js and Next.js**.  
Experienced in converting UI/UX designs into responsive components, integrating REST APIs, and fixing cross-browser issues in real-world systems.
...
const imran = {
  ...
  experience: "1+ year",
  focus: ["React.js", "Next.js", "Reusable UI", "API Integration"],
  availableFor: "Frontend roles & freelance work",
};
```
